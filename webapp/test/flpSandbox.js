			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioritask01-display": {
								"semanticObject": "fioritask01",
								"action": "display",
								"description": "use smart filter to hide a column",
								"title": "Task 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioritask01",
									"url": sap.ui.require.toUrl("fioritask01")
								}
							}
						}
					}
